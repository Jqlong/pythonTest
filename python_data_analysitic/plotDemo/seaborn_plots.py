...
plt.suptitle("Join Plot of Two Variables with Bivariate  and Univariate Graphs")
# 成对变量之间的散点图与单变量直方图
iris = sns.utils.load_dataset("iris")
sns.pairplot(iris)
# 按照某几个变量生成的箱线图
tips = sns.utils.load_dataset("tips")
...
plt.show()
savefig('output/seaborn_plots.png')
